					...
					<div class="card-body">
						<div class="row">
							<div class="col-8 align-self-start">
								<h4 class="card-title"><b><?=$componente->titulo?></b></h4>	
							</div>
							<div class="col align-self-end">
								<h4><?=$componente->moneda.$componente->precio?></h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-auto">
								<img class="car-img-top" style="width: 200px; height: 200px;" src="<?php echo base_url();?><?=$componente->imagen?>" alt="Card image cap">
							</div>
							<div class="col">
								<h5 class="card-title"><b>Provincia: </b><?=$componente->provincia?></h5>
								<h5 class="card-title"><b>Telefono: </b><?=$componente->telefono?></h5>
								<h5 class="card-title"><b>Tipo: </b><?=$componente->tipo?></h5>
								<h5 class="card-title"><b>Marca: </b><?=$componente->marca?></h5>
								<h5 class="card-title"><b>Modelo: </b><?=$componente->modelo?></h5>
								<h5 class="card-title"><b>Accion: </b><?=$componente->accion?></h5>
								<h5 class="card-title"><b>Agregado: </b><?php echo date("j F, Y", $componente->fechaini);?></h5>
							</div>
						</div>	
						<h4>Descripcion:</h4>
