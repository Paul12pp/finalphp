					...
					<div class="card-body">
						<div class="row">
							<div class="col-8 align-self-start">
								<h4 class="card-title"><b><?=$bicicleta->titulo?></b></h4>	
							</div>
							<div class="col align-self-end">
								<h4><?=$bicicleta->moneda.$bicicleta->precio?></h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-auto">
								<?php $link = base_url();?>
								<img class="car-img-top" src="<?=$link.'mthumb.php?src='.$link.$bicicleta->imagen.'&w=250&h=250'?>" alt="Card image cap">
							</div>
							<div class="col">
								<h5 class="card-title"><b>Provincia: </b><?=$bicicleta->provincia?></h5>
								<h5 class="card-title"><b>Telefono: </b><?=$bicicleta->telefono?></h5>
								<h5 class="card-title"><b>Tipo: </b><?=$bicicleta->tipo?></h5>
								<h5 class="card-title"><b>Marca: </b><?=$bicicleta->marca?></h5>
								<h5 class="card-title"><b>Modelo: </b><?=$bicicleta->modelo?></h5>
								<h5 class="card-title"><b>Tamaño del aro: </b><?=$bicicleta->tmaro?></h5>
								<h5 class="card-title"><b>Tamaño del cuadro: </b><?=$bicicleta->tmcuadro?></h5>
								<h5 class="card-title"><b>Accion: </b><?=$bicicleta->accion?></h5>
								<h5 class="card-title"><b>Agregado: </b><?php echo date("j F, Y", $bicicleta->fechaini);?></h5>
							</div>
						</div>	
						<h4>Descripcion:</h4>
