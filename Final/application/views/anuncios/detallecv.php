					...
					<div class="card-body">
						<div class="row">
							<div class="col-8 align-self-start">
								<h4 class="card-title"><b><?=$servicio->titulo?></b></h4>	
							</div>
							<div class="col align-self-end">
								<h4><?=$servicio->moneda.$servicio->precio?></h4>
							</div>
						</div>
						<div class="row">
							...
							<div class="col">
								...
								<h5 class="card-title"><b>Telefono: </b><?=$servicio->telefono?></h5>
								<h5 class="card-title"><b>Accion: </b><?=$servicio->accion?></h5>
								<h5 class="card-title"><b>Agregado: </b><?php echo date("j F, Y", $servicio->fechaini);?></h5>
							</div>
						</div>	
						<h4>Descripcion:</h4>
