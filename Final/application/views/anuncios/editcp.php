					...
					<div class="row">
						...
						<div class="col-md-8" style="background-color: ;">
							...
							<form method="post" action="<?php echo base_url('anuncio/guardarBici'); ?>" enctype="multipart/form-data">
								<div class="form-group">
									<input hidden readonly class="form-control" type="text" value="<?=$componente->id?>" name="id">
								</div>
								<div class="form-group">
									...
									<select class="form-control provincia" name="provincia" required="">
										...
										<?php 
											...
											for( $i=0; $i<count($option); $i++ ) {
											    if($componente->provincia==$option[$i]){
								...
								<div class="form-group">
									<label>Tel./cel (*)</label>
									<input class="form-control" type="text" value="<?=$componente->telefono?>" name="telefono" required>
								</div>
								<div class="form-group">
									<label>Tipo (*)</label>
								...
								<div class="form-group">
									<label>Modelo</label>
									<input class="form-control" type="text" value="<?=$componente->modelo?>" name="modelo">
								</div>
								<div class="form-group">
									<label>Accion (*)</label>
								...
								<div class="form-group">
									<label>Precio (*)</label>
									<input class="form-control" value="<?=$componente->precio?>" type="text" name="precio" required>
								</div>
								<div class="form-group">
									<label>Titulo del anuncio (*)</label>
									<input class="form-control" type="text" value="<?=$componente->titulo?>" name="titulo" required>
								</div>
								<div class="form-group">
									<label>Descripcion (*)</label>
									<textarea class="form-control" name="descripcion" required><?=$componente->descripcion?></textarea>
								</div>
								...
								<div class="form-group">
									<input hidden class="form-control" type="text" value="<?=$componente->categoria?>" name="categoria" required>
								</div>
								<div class="form-group">
									<input hidden class="form-control" type="text" value="<?=$componente->fechaini?>" name="fechaini" required>
								</div>
								<div class="form-group">
									<input hidden class="form-control" type="text" value="<?=$componente->fechafin?>" name="fechafin" required>
								</div>
