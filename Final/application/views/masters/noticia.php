											...
											<div class='col'>
												<div class='row'>
													<div class='col-8 align-self-start'>
														<h5 class='card-title'><b>{$noti->titulo}</b></h5>
														<div class='row'>
															<div class='col'>
																<h6 class='card-subtitle mb-2 text-muted'>{$noti->username}</h6>
															</div>
															<div class='col'>
																<h6 class='card-subtitle mb-2 text-muted'>{$noti->fecha}</h6>
															</div>
														</div>
													</div>
